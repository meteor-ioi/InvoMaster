...
export default function TemplateReference({ theme, device, headerCollapsed = false }) {
    ...
    const getMarkdown = () => {
        ...
        md += `\n*Generated by InvoMaster Analyzer*`;
        return md;
    };
                        ...
                        <>
                            ...
                            <div className="glass-card" style={{
                                ...
                                <div style={{
                                    ...
                                    <span style={{ fontSize: '13px', fontWeight: 'bold', color: 'var(--text-primary)' }}>数据提取</span>
                                </div>
                ...
                <div className="glass-card" style={{
                    ...
                    <div style={{
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                            ...
                            <span style={{ fontSize: '15px', fontWeight: 'bold' }}>数据预览</span>
                        </div>
